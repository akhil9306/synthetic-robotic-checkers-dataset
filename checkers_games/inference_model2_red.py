# Inference: Model 2 (Medium NN) — Human plays RED, Computer plays BLACK
...
from checkers_core import (
    MediumModel, initializeBoard, possibleMoves, chooseMove,
...
weights_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'model2_weights.pt')
model.load_state_dict(torch.load(weights_path, map_location=device, weights_only=True))
model.eval()

print("Model 2 (Medium NN: 7->64->32->1) loaded successfully!")
